_base_ = [
    '../_base_/models/segformer_mit-b0.py', '../_base_/datasets/cracks_and_potholes_640x640.py',
...
model = dict(
    ...
    decode_head=dict(
        ...
        loss_decode=[
            ...
            dict(type='DiceLoss', loss_name='loss_dice', loss_weight=1.0, class_weight=[0.001, 0.999, 0.999])
        ]
    )
)
